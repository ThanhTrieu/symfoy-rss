...
class MobileKernel extends BaseKernel
{
    ...
    {
        return $this->getProjectDir().'/var/cache/mobile/'.$this->environment;
    }

    public function getLogDir()
    {
        return $this->getProjectDir().'/var/log/mobile';
    }
    ...
    protected function configureContainer(ContainerBuilder $container, LoaderInterface $loader)
    {
        ...
        $loader->load($confDir.'/mobile/{packages}/*'.self::CONFIG_EXTS, 'glob');
        $loader->load($confDir.'/{packages}/'.$this->environment.'/**/*'.self::CONFIG_EXTS, 'glob');
        $loader->load($confDir.'/{services}'.self::CONFIG_EXTS, 'glob');
        $loader->load($confDir.'/{services}_'.$this->environment.self::CONFIG_EXTS, 'glob');
        $loader->load($confDir.'/mobile/{services}'.self::CONFIG_EXTS, 'glob');
        $loader->load($confDir.'/mobile/{services}_'.$this->environment.self::CONFIG_EXTS, 'glob');
    }
    ...
    protected function configureRoutes(RouteCollectionBuilder $routes)
    {
        ...
        $routes->import($confDir.'/mobile/{routes}/*'.self::CONFIG_EXTS, '/', 'glob');
        $routes->import($confDir.'/mobile/{routes}/'.$this->environment.'/**/*'.self::CONFIG_EXTS, '/', 'glob');
        $routes->import($confDir.'/mobile/{routes}'.self::CONFIG_EXTS, '/', 'glob');
    }
