...
class AuthorController extends BaseController
{
     ...
     */
    public function list($authorSlug, $currentPage = 1, DataExchange $dataExchangeService, Request $request, CryptUtils $cryptUtils)
    {
        ...
        $articleKeyCache = $this->formatCacheKey(Constants::CACHE_AUTHOR_LASTEST_PAGE, $postAuthor, $currentPage);
