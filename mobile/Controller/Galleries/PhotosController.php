...
class PhotosController extends BaseController
{
    ...
    public function list(Request $request, DataExchange $dataExchangeService, CryptUtils $cryptUtils)
    {
        ...
        $photosKeyCache = $this->formatCacheKey(Constants::CACHE_PHOTOS_PAGE, $key);
        ...
        if ($photoGalleries === false) {
            ...
            $data = $em->getRepository(PhotoGalleries::class)->getPhotoGalleriesPaging($currentPage, Constants::PAGE_SIZE_MOBILE);
            if ($data) {
