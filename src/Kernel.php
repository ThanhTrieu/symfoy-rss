...
class Kernel extends BaseKernel
{
    ...
    {
        return $this->getProjectDir().'/var/cache/desktop/'.$this->environment;
    }

    public function getLogDir()
    {
        return $this->getProjectDir().'/var/log/desktop';
    }
    ...
    protected function configureContainer(ContainerBuilder $container, LoaderInterface $loader)
    {
        ...
        $loader->load($confDir.'/desktop/{packages}/*'.self::CONFIG_EXTS, 'glob');
    ...
    protected function configureRoutes(RouteCollectionBuilder $routes)
    {
        ...
        //$routes->import($confDir.'/desktop/{routes}/*'.self::CONFIG_EXTS, '/', 'glob');
        $routes->import($confDir.'/desktop/{routes}/'.$this->environment.'/**/*'.self::CONFIG_EXTS, '/', 'glob');
        $routes->import($confDir.'/desktop/{routes}'.self::CONFIG_EXTS, '/', 'glob');
    }
